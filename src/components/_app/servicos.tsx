            ...
            {servicos.map((servico, index) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex items-center gap-4 flex-1">
                        <div className="w-14 h-14 flex items-center justify-center flex-shrink-0">
                          <div className="p-3 bg-[#5C4373]/10 rounded-full group-hover:bg-[#5C4373] transition-all duration-300 group-hover:scale-110 flex items-center justify-center">
                            <IconComponent className="h-6 w-6 text-[#5C4373] group-hover:text-white transition-colors duration-300" />
                          </div>
                        </div>
                        <CardTitle className="text-xl font-bold text-gray-900 group-hover:text-[#5C4373] transition-colors duration-300">
                          {servico.title}
                        </CardTitle>
                      </div>
                      <div className="w-6 h-6 flex items-center justify-center flex-shrink-0">
                        <ChevronDown
                          className={`h-6 w-6 text-[#5C4373] transition-transform duration-300 ${
                            isOpen ? "rotate-180" : ""
                          }`}
                        />
                      </div>
                  ...
                  >
                    <CardContent className="pt-0 pb-6 px-6 pl-[88px]">
